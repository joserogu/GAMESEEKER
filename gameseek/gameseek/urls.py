...
urlpatterns = [
    ...
    path('eventos/<int:pk>/', EventUpdateView.as_view(), name='event-update'),
    ...
    path('comunidades/<int:pk>/', CommunityUpdateView.as_view(), name='community-update'),
    ...
    path('juegos/<int:pk>/', GameUpdateView.as_view(), name='game-update'),
